...
class ConsumableServiceImplTest {
    ...
    @InjectMocks private ConsumableService consumableService;
    ...
    @Test
    void whenUploadExcel_returnIOExceptionFromExcelConsumablesProcess() {
        fail(NOT_YET_IMPLEMENTED);
    }

    @Test
    void whenUploadExcel_Consumables_returnConsumablesUploaded() {
        fail(NOT_YET_IMPLEMENTED);
    }
