...
public class UserMock {
    ...
    public static UserDto getRandomMockedUser() {
        ...
        return getMockedUser().toBuilder()
            .id(id)
            .email(getRandomElementFromList(UserMock.emails))
            .volunteer(volunteerFromMocked.toBuilder()
                .name(getRandomElementFromList(UserMock.names))
                .lastName(String.format("%s %s",
                    getRandomElementFromList(UserMock.lastNames), getRandomElementFromList(UserMock.lastNames)))
